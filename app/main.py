...
from app.routers import auth, players, sessions, transactions, stats, config, tournaments, history, payments, audit, users, dealers, public, dealer_self, player_self, blind_templates, reports, push
...
app.include_router(dealers.shifts_router)
app.include_router(dealers.alerts_router)
